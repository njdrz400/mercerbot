...
static const _QuaternionToEuler_Event_type_support_symbol_names_t _QuaternionToEuler_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arduinobot_msgs, srv, QuaternionToEuler_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arduinobot_msgs, srv, QuaternionToEuler_Event)),
  }
};
...
{
  return &::arduinobot_msgs::srv::rosidl_typesupport_cpp::QuaternionToEuler_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, arduinobot_msgs, srv, QuaternionToEuler_Event)() {
  return get_message_type_support_handle<arduinobot_msgs::srv::QuaternionToEuler_Event>();
}
...
static const rosidl_service_type_support_t QuaternionToEuler_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<arduinobot_msgs::srv::QuaternionToEuler_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<arduinobot_msgs::srv::QuaternionToEuler_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<arduinobot_msgs::srv::QuaternionToEuler_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, arduinobot_msgs, srv, QuaternionToEuler)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<arduinobot_msgs::srv::QuaternionToEuler>();
}
