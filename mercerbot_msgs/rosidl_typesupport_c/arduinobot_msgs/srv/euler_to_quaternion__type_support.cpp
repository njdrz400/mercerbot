...
static const _EulerToQuaternion_Event_type_support_symbol_names_t _EulerToQuaternion_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_msgs, srv, EulerToQuaternion_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arduinobot_msgs, srv, EulerToQuaternion_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, arduinobot_msgs, srv, EulerToQuaternion_Event)() {
  return &::arduinobot_msgs::srv::rosidl_typesupport_c::EulerToQuaternion_Event_message_type_support_handle;
}
