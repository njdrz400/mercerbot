...
arduinobot_msgs__srv__AddTwoInts_Request__create(void)
{
...
arduinobot_msgs__srv__AddTwoInts_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
arduinobot_msgs__srv__AddTwoInts_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
